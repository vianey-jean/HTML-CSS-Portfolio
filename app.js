...
.pauseFor(1800)
.changeDelay(20)
.typeString('Moi c\'est Jean RABEMANALINA')
.pauseFor(300)
.typeString('<strong>, Développeur Full-Stack</strong> !')
.pauseFor(1000)
.deleteChars(13)

.typeString('<span style="color: midnightblue;"> HTML/CSS/Bootstrap/JS</span> !')
.pauseFor(1000)
.deleteChars(23)
...
.typeString('<span style="color: midnightblue;"> React Natifs</span> !')
.pauseFor(1000)
.deleteChars(15)
...
.typeString('<span style="color: midnightblue;"> Symfony</span> !')
.pauseFor(1000)
.deleteChars(10)
